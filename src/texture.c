...
ULONG tex_GLFilter2W3D(GLenum filter)
{
    ...
    case GL_NEAREST_MIPMAP_NEAREST:
        return W3D_NEAREST; // W3D_NEAREST_MIP_NEAREST;
    case GL_LINEAR_MIPMAP_NEAREST:
        return W3D_LINEAR; // W3D_LINEAR_MIP_NEAREST;
    case GL_NEAREST_MIPMAP_LINEAR:
        return W3D_NEAREST; // W3D_NEAREST_MIP_LINEAR;
    case GL_LINEAR_MIPMAP_LINEAR:
        return W3D_LINEAR; // W3D_LINEAR_MIP_LINEAR;
    }
...
#define ARGBFORM(a, r, g, b) \
    ((UWORD)((((a & 0xf0) << 8) | ((r & 0xf0) << 4) | ((g & 0xf0)) | ((b & 0xf0) >> 4))))
...
#define RGBFORM(r, g, b) \
    ((UWORD)(((r & 0xF8) << 8) | ((g & 0xFC) << 3) | ((b & 0xF8) >> 3)))
